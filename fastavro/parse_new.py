...
def reassemble_schema(schema: Any, schemas_dict: Any, error_on_unknown: bool) -> Any:
    assembler = Assembler(schemas_dict, error_on_unknown)
    schema = depth_first_walk_schema(schema, assembler.before, lambda x: x)
    return (schema, assembler.missing_schema_names)
